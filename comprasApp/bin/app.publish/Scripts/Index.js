$(document).ready(function () {
    ...
    function getConditions() {
        ...
        var listEnvases = document.getElementById('listEnvases');
        ...
        var elementosEnvases = obtenerElementosSeleccionadosDeSelect(listEnvases);
        ...
        if (elementosEnvases.length > 0) {
            filtroEnvases = " AND ("
            elementosEnvases.forEach((element) => filtroEnvases += "compras.dbo.Envase.YX_LIBELLE='" + element + "' or ");
            filtroEnvases = filtroEnvases.slice(0, -3) + ')';
        }
        ...
        return filtroMarcas + filtroTiendas + filtroProveedores + filtroEnvases + filtroRubros;
    }
    ...
    document.getElementById('cleanEnvase').addEventListener('click', function () {
        clearListSelection('listEnvases');
    });
